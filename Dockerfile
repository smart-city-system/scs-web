...
ARG NEXT_PUBLIC_CAMERA_ENDPOINT
ARG NEXT_PUBLIC_NOTIFICATION_ENDPOINT

# Set environment variables from build arguments
ENV NEXT_PUBLIC_USER_ENDPOINT=$NEXT_PUBLIC_USER_ENDPOINT
ENV NEXT_PUBLIC_API_ENDPOINT=$NEXT_PUBLIC_API_ENDPOINT
ENV NEXT_PUBLIC_CAMERA_ENDPOINT=$NEXT_PUBLIC_CAMERA_ENDPOINT
ENV NEXT_PUBLIC_NOTIFICATION_ENDPOINT=$NEXT_PUBLIC_NOTIFICATION_ENDPOINT
